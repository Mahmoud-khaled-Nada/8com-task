...
import { Plus, Edit, Trash2, AlertTriangle, Zap } from "lucide-react";
    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        ...
        <div className="flex space-x-4">
          <Button onClick={() => setShowFlashSaleForm(true)} className="bg-orange-600 hover:bg-orange-700">
      ...
      <FlashSaleForm isOpen={showFlashSaleForm} onClose={() => setShowFlashSaleForm(false)} />
    </div>
  );
};
